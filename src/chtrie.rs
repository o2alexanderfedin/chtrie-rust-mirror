    ...
    loop {
        ...
        '__s1:
            ...
            match __state {
                ...
                3 => { unsafe { free(tr as *mut ()) }; __state = 29; }
                4 => { return 0 as *mut () as *mut Chtrie; }
                5 => {
                    if n < 1 as u64 { __state = 7; } else { __state = 6; }
                }
                6 => {
                    if m < 1 as u64 { __state = 9; } else { __state = 8; }
                }
                7 => { n = 1 as u64; __state = 6; }
                8 => {
                    if n > 2147483647 as u64 || m > 2147483647 as u64 {
                        __state = 11;
                    } else { __state = 10; }
                }
                9 => { m = 1 as u64; __state = 8; }
                10 => {
                ...
                11 => { unsafe { *unsafe { __error() } = 34 }; __state = 12; }
                12 => { __state = 4; }
                13 => {
                    if ({
                                            tr =
                                                unsafe {
                                                        calloc(1 as u64, core::mem::size_of::<Chtrie>() as u64)
                                                    } as *mut Chtrie;
                                            tr
                                        }).is_null() as i32 != 0 {
                        __state = 17;
                ...
                14 => { unsafe { *unsafe { __error() } = 34 }; __state = 15; }
                15 => { __state = 4; }
                16 => { unsafe { (*tr).maxn = n as i32 }; __state = 18; }
                17 => { __state = 4; }
                18 => { unsafe { (*tr).alphsz = m as i32 }; __state = 19; }
                19 => {
                    unsafe {
                        (*tr).ecap =
                            n.wrapping_sub(1 as
                                            u64).wrapping_add(n.wrapping_sub(1 as u64) / 3 as u64) as
                                i32
                    };
                    __state = 20;
                }
                ...
                21 => {
                    if ({
                                            let __v =
                                                unsafe { calloc(n, core::mem::size_of::<i32>() as u64) } as
                                                    *mut i32;
                ...
                22 => { __state = 3; }
                23 => { unsafe { (*tr).idxmax = 1 }; __state = 25; }
                24 => { __state = 2; }
                25 => {
...
pub(crate) extern "C" fn chtrie_walk(tr: &mut Chtrie, from: i32, sym: i32,
    creat: i32) -> i32 {
    let mut p: *mut ChtrieEdge = core::ptr::null_mut();
    let mut h: u64 = 0 as u64;
    h =
        (from as
                    u64).wrapping_mul((*tr).alphsz as
                    u64).wrapping_add(sym as u64);
    h %= (*tr).ecap as u64;
    {
    ...
    if creat != 0 {
        ...
        if ({
                                p =
                                    unsafe { malloc(core::mem::size_of::<ChtrieEdge>() as u64) }
                                        as *mut ChtrieEdge;
                                p
                            }).is_null() as i32 != 0 {
            return -1;
...
pub(crate) extern "C" fn chtrie_del(tr: &mut Chtrie, from: i32, sym: i32)
    ...
    if !(q).is_null() {
        ...
        unsafe {
            *(*tr).etab.add(h as usize) = 0 as *mut () as *mut ChtrieEdge
        };
    }
    unsafe {
        *{
...
pub(crate) extern "C" fn chtrie_free(tr: *mut Chtrie) -> () {
    ...
    let mut i: i32 = 0;
    {
        i = 0;
        '__b4: loop {
            if !(i < unsafe { (*tr).ecap }) { break '__b4; }
            '__c4: loop {
